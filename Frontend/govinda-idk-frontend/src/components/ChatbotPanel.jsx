...
export default function ChatbotPanel({ config, setConfig }) {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: '👋 Welcome to Govinda Builder! I can help you create and configure dynamic components. Try editor tab to modify JSON directly, or chat with me for assistance.',
  ...
  const generateBotResponse = (message) => {
    ...
    if (lowerMessage.includes('dashboard')) {
      return '📊 I can help you create a dashboard! Try switching to Editor tab and use the Dashboard preset, or tell me what specific metrics you want to display.';
    } else if (lowerMessage.includes('book') || lowerMessage.includes('document')) {
      return '📚 For a book/document layout, use the Book preset in the Editor tab. You can customize the title and content fields to match your needs.';
    } else if (lowerMessage.includes('help')) {
      return '🤖 I can help you:\n\n• Configure component layouts\n• Edit JSON metadata\n• Switch between dashboard and book views\n• Format and validate your configuration\n\nTry the Editor tab for direct JSON editing!';
    } else {
      return '💡 Interesting! Try the Editor tab to modify the JSON configuration directly, or ask me about specific features like "dashboard" or "book layouts".';
    }
  };
