...
You can return the answer in any order.`,
  ...
  const analyzeCode = async () => {
    ...
    try {
      ...
      const response = await axios.post("/compilecodeai", { code });
              ...
              <div className="test-cases-output">
                ...
                <div className="test-case-results">
                  {terminal ? (
                    ...
                    <div className="test-placeholder">Click "Submit" to run all test cases</div>
                  )}
                </div>
              </div>
            )}
            ...
            {activeOutputTab === "analysis" && (
              <div className="analysis-output">
                ...
                {analysis ? (
                  ...
                  <div className="analysis-placeholder">Click "Analyze" to get AI insights</div>
                )}
              </div>
            )}
          </div>
